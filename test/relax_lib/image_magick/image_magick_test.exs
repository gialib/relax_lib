defmodule RelaxLib.ImageMagickTest do
  import RelaxLib.ImageMagick
  alias RelaxLib.ImageMagick.Image

  use ExUnit.Case, async: true

  @fixture Path.join(__DIR__, "../../fixtures/image_magick/bender.jpg")
  @fixture_with_space Path.join(__DIR__, "../../fixtures/image_magick/image with space in name/ben der.jpg")
  @fixture_animated Path.join(__DIR__, "../../fixtures/image_magick/bender_anim.gif")
  ...
  test ".open" do
    image = open("./test/fixtures/image_magick/bender.jpg")
  ...
  test ".open when file name has spaces" do
    image = open("./test/fixtures/image_magick/image with space in name/ben der.jpg")
    assert %Image{ext: ".jpg"} = image
  ...
  test ".open when file does not exist" do
    assert_raise File.Error, fn ->
      open("./test/fixtures/image_magick/does_not_exist.jpg")
    end
  end
